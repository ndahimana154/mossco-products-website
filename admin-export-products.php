                        ...
                        if (mysqli_num_rows($get_product) < 1) {
                            ...
                            <form action="" method="post">
                                <?php
                                    if (isset($_POST['save_product_import_BTN'])) {
                                        ...
                                        if ($current_quantity < $quantity) {
                                            ?>
                                            <p class="alert alert-danger">
                                                Export quantity is greater than the stock
                                            </p>
                                            <?php
                                        }
                                        elseif ($quantity == 0) {
                                            ?>
                                            <p class="alert alert-danger">
                                                Zero export is not allowed.
                                            </p>
                                            <?php
                                        }
                                        else {
                                            $save = mysqli_query($server,"INSERT into product_inventory VALUES(null,'$product','OUT','$price','$quantity',now(),'Performed','$acting_admin_id')");
                                            if (!$save) {
                                                ?>
                                                <p class="alert alert-danger">
                                                ...
                                                if (!$update) {
                                                    ...
                                                    <p class="alert alert-success">
                                                        Product is exported successfully. The new quantity is <b><?php echo $new_quantity; ?></b>
                                                    </p>
                                                    <?php
                                                }
                                            }
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" value="<?php echo $current_quantity; ?>" placeholder="Type..." class="form-control" readonly>
                                </div>
